        ...
        <el-row :gutter="15">
          <el-col :span="12" v-for="panel in panelList" :key="panel.id" style="margin-bottom: 20px;">
            <div class="iframe-container">
              ...
              <iframe :src="getPodGrafanaUrl(panel.id, podName)" width="100%" height="280" frameborder="0" scrolling="no"></iframe>
            </div>
          </el-col>
        </el-row>
      </div>
...
import { getPodDetail, getPodGrafanaUrl, panelList } from '@/api/monitor/kuber/pod'
